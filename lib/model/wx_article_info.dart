...
@JsonSerializable()
class WxArticleInfo extends Object {
  ...
  WxArticleInfo(this.curPage,this.datas,this.offset,this.over,this.pageCount,this.size,this.total,);

  factory WxArticleInfo.fromJson(Map<String, dynamic> srcJson) => _$WxArticleInfoFromJson(srcJson);

  Map<String, dynamic> toJson() => _$WxArticleInfoToJson(this);
